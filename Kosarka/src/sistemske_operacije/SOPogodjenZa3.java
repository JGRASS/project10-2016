 ...
 * 
 * */
public class SOPogodjenZa3 {
	/**Metoda koja vraca broj pogodjenih koseva za 3
	...
	public static int izvrsi(List<Tim> timovi, Tim t) {
		...
		for(int i=0;i<timovi.get(SOPozicijaTima.izvrsi(timovi,t)).getUtakmice().size();i++){
			uk = uk + timovi.get(SOPozicijaTima.izvrsi(timovi,t)).getUtakmice().get(i).getStatistika().getPogodjeniZaTri();
